...
- The mystery map now renders a centered, property-free country silhouette on a blank basemap, so the basemap cannot reveal the country's location or label before the player guesses.
